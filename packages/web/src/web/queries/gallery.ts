...
export type GalleryItem = Awaited<ReturnType<typeof import("../lib/api").client.gallery.list>>[number];

export function useGallery(input: {
  search?: string;
  category?: string;
...
export function useToggleLike(listInput: { search?: string; category?: string; sort?: "trending" | "recent" }) {
